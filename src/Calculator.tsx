            ...
            <div className='calculator bg-white rounded-bl-[25px] rounded-tl-[25px] w-full'>
                ...
                <div className='inputs'>
                    ...
                    <fieldset className='mortgage-type flex flex-col gap-2.5'>
                        <legend className='font-bold'>Mortgage Type</legend>
