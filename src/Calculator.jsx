        ...
        <div className='calculator'>
            ...
            <div className='inputs'>
                ...
                <div className='flex gap-2.5 mt-5'>
                    <button className='flex calculate-btn font-bold w-full justify-center'><img src="./assets/images/icon-calculator.svg" alt="Calculate" />Calculate Repayments</button>
                </div>
            </div>
        </div>
    )
